...
class CarRacing:
    ...
    def display_credit(self):
        ...
        text = font.render("Hope You,", True, self.white)
        self.gameDisplay.blit(text, (600, 520))
        text = font.render("Liked", True, self.white)
        self.gameDisplay.blit(text, (600, 530))
        text = font.render("The Game", True, self.white)
        self.gameDisplay.blit(text, (600, 540))
        text = font.render("Brought To You By", True, self.white)
        self.gameDisplay.blit(text, (600, 560))
        text = font.render("Shivang", True, self.white)
